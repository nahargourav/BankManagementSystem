...
public class SignupTwo extends JFrame implements ActionListener {
    ...
    SignupTwo(String formno) {
        ...
        String educationalValues[]={"Under Graduate","Graduate","Post-graduate","Doctrate","Others"};
        ...
        add(sno);
        // to ensure ony one of the radio button is selected
    ...
    public void actionPerformed(ActionEvent ae){
        String sreligion = (String)religion.getSelectedItem();  //To extract text from textfield
        ...
        try{
            Conn c = new Conn();
            //DML command - Datata manipulation language
            ...
            //to attach a variable in string format in middle
            //"String'"+variable+"'String"
            c.s.executeUpdate(query);  //DML cmd
